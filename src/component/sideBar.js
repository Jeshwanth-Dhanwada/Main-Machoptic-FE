              ...
              <Tooltip title="Operations" placement="right">
                ...
                >
                  <MenuItem
                    ...
                    className="label"
                    // icon={<SiRedhatopenshift className="sidebar-icon" style={{color:'#505050'}}/>}
                    icon={
                      <svg
                        className="sidebar-icon"
                        style={{ color: "#505050" }}
